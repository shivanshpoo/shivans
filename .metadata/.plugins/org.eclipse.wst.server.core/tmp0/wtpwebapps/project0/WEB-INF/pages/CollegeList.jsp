						...
						<table class="table table-hover table-striped border border-secondary">
							<thead >
								<tr>
									...
									<th scope="col" class="text-center"><s:message code="label.address"/></th>
									<th scope="col" class="text-center"><s:message code="label.state"/></th>
									<th scope="col" class="text-center"><s:message code="label.city"/></th>
									<th scope="col" class="text-center"><s:message code="label.phoneNo"/></th>
							...
							<c:forEach items="${list}" var="college" varStatus="ct">
								<tr>
									<td class="text-center">
										<input class="case" name="chk_1" type="checkbox" value="${college.id}">
									</td>
									<td class="text-center">
									...
									<td class="text-center">
										<c:url var="editUrl" value="/ctl/College/College?id=" />
              							<a class="btn btn-outline-warning btn-block btn-round w-100" href="${editUrl}${college.id}"><i class="fa fa-trash" aria-hidden="true"></i><s:message code="label.edit"/></a>
									</td>
								</tr>
							</c:forEach>
							</tbody>
