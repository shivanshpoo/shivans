...
<body>
<div class="row d-flex justify-content-center" style="height: 955px;">
						...
						<table class="table table-hover table-striped border border-secondary">
							...
							<c:forEach items="${list}" var="faculty" varStatus="ct">
								<tr>
									...
									<c:if test="${faculty.courseId==course.id}">
									...
									<td class="text-center">${faculty.loginId}</td>
									<td class="text-center">${faculty.mobileNo}</td>
									<td class="text-center"><fmt:formatDate value="${faculty.doj}" type="date" pattern="dd-MM-yyyy"/></td>
