		...
		<div class="signup-form"
			...
			<div class="form-group">
				<sf:label path="courseId">
					...
					<span style="color: red;">*</span>
					<div class="input-group" style="width: 171%">
						<span class="input-group-addon"><i
			...
			<div class="form-group">
				<sf:label path="loginId">
					...
					<div class="input-group" style="width: 130%">
						...
						<sf:input path="loginId" class="form-control"
							placeholder="${enteremail}" />
					</div>
					<font color="red"> <sf:errors path="loginId" /></font>
				</sf:label>
			</div>
			...
			<div class="form-group">
				<sf:label path="doj">
					...
					<div class="input-group" style="width: 130%">
						...
						<sf:input path="doj" class="form-control" id="datepicker"
							placeholder="${enterdob}" autocomplete="off" />
					</div>
					<font color="red"><sf:errors path="doj" /></font>
				</sf:label>
			</div>
				...
				<c:choose>
					<c:when test="${form.id==0}">
						...
						<button type="submit" name="operation" value="save"
							class="btn btn-success" style="margin-left: 45px">
							<span class="glyphicon glyphicon-check"></span>
							<s:message code="label.save" />
						</button>

						<button type="submit" name="operation" value="reset"
							class="btn btn-warning" style="margin-left: 45px">
