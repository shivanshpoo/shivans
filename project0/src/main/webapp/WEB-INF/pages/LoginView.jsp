...
<link
 ...
 <br>
 <br>
<div class="login-form" style="margin-left: 293px; height: 500px;">
...
<sf:form method="post" modelAttribute="form" >
        ...
        <h2 class="text-center" style="width: 8cm;"><s:message code="label.login"></s:message></h2> 
	   ...
	   <div class="form-group">	
        ...
        <div class="form-group" style="width: 20%;">
            ...
            <button type="submit" name="operation" class="btn btn-success " value="SignIn"><s:message code="label.login"/></button>
            <button type="submit" name="operation" class="btn btn-primary" value="SignUp"><s:message code="label.userRegistration"/></button>
            </div>
       
        <div class="clearfix">
            <a href="<c:url value="/UserRegistration" />"><s:message code="label.signupp"/></a> &nbsp;||
            <a href="<c:url value="/ForgetPassword"/>" class="right" ><s:message code="label.forgetpassword" /></a>
        </div> 
