...
<%@page import="in.co.sunrays.project0.controller.MarksheetCtl"%>
...
<body>
<div style="height: 710px;margin-top: 45px">
...
<sf:form method="post" modelAttribute="form" name="frm">
     ...
     <div class="row" style="margin-top:0px;">
               ...
               <sf:input path="rollNo" class="form-control" placeholder="${enterrollno}"/>
                ...
                <abbr title="${search}">
                <button type="submit" class="btn btn-secondary btn-block" name="operation" value="Search" >
              ...
              <abbr title="${reset}">
              <button type="submit" class="btn btn-secondary btn-block" name="operation" value="reset">
