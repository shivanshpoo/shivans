...
<link
	href="<c:url value ="http://localhost:8080/project0/resources/css/menumove.css"></c:url>"
	rel="stylesheet" />
<style type="text/css">
table, th {
	font-weight: bolder;
			...
			<div class="card card-table">
				...
				<sf:form method="post" modelAttribute="form">
					...
					<c:if test="${!empty list}">
						...
						<center>
							<div class="social-line align-self-center text-center col-lg-6"
										...
										<c:forEach items="${list}" var="role" varStatus="ct">
											<tr>
												...
												<td class="text-center"><c:url var="editUrl"
														value="/ctl/Role/Role?id=" /> <a
													class="btn btn-outline-warning btn-block btn-round w-100"
													href="${editUrl}${role.id}"><i class="fa fa-trash"
														aria-hidden="true"></i>
						...
						<div class="row d-flex justify-content-center">
							<div class="col-lg-1 col-3">
								<c:choose>
									<c:when test="${form.pageNo > 1}">
										<button type="submit" style="width: 125px; margin-left: -25px"
											class="btn btn-outline-primary btn-block btn-round"
									...
									<c:otherwise>
										<button type="submit" style="width: 125px; margin-left: -25px"
											class="btn btn-outline-secondary btn-block btn-round"
							...
							<div class="col-lg-1 col-3">
								<button type="submit"
									class="btn btn-outline-success btn-block btn-round"
							...
							<div class="col-lg-1 col-3">
								<button type="submit" style="width: 100px; margin-left: -25px"
							...
							<div class="col-lg-1 col-3">
								<c:choose>
									<c:when test="${nextlistsize !=0}">
										<button type="submit" style="width: 85px; margin-left: -25px"
											class="btn btn-outline-primary btn-block btn-round"
